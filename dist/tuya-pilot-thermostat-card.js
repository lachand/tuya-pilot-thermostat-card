        ...
        <div class="header">
          <div>
            <div class="title">
              ...
              ${$?j`<span class="badge" title="${e("Child lock","Verrou enfant")}">🔒</span>`:""}
            </div>
