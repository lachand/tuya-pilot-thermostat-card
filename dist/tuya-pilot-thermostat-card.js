        ...
        <div class="header">
          <div>
            <div class="title">
              ...
              ${$?R`<span class="badge" title="${e("Child lock","Verrou enfant")}">🔒</span>`:""}
            </div>
